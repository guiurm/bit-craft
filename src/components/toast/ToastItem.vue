...
type TProps = { message?: string; liveTime?: number; showLifeTime?: boolean; modelValue?: boolean };
const props = withDefaults(defineProps<TProps>(), { liveTime: -1, showLifeTime: true, modelValue: true });
