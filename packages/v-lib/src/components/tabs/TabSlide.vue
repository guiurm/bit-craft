...
import { computed, inject, onBeforeMount, onBeforeUnmount, ref, watch, type Ref } from "vue";
...
const props = withDefaults(
    ...
    { active: false, transitionName: "fade-abs", class: "" }
);
...
<template>
    ...
    <transition :name="transition">
        <div v-if="tabR.active" :class="css" class="">
            <slot />
        </div>
    </transition>
</template>
